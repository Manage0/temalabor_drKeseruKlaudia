                ...
                <tr>
                    ...
                    <td id="formTD">
                        <form name="contact" method="POST" data-netlify="true" enctype="application/x-www-form-urlencoded">
                            ...
                            <div>
                                    <input type="text" class="input" name="Teljes nev" placeholder={lang === "hun" ? "Adja meg a teljes nevét!" : "Bitte geben Sie Ihren vollen Namen ein!"} onChange={(e) => NameSet(e.target.value)} />
                            </div>
                            <div>
                                <input type="text" class="input" name="Telefonszam" placeholder={lang === "hun" ? "Adja meg a telefonszámát!" : "Bitte geben Sie Ihre Telefonnummer ein!"} onChange={(e) => PhoneSet(e.target.value)} />
                            </div>
                            <div>
                            ...
                            <div>
                                <textarea class="input" id="description" name="Kerdes" placeholder={lang === "hun" ? "Írja le röviden kérdését! (max. 200 karakter)" : "Bitte beschreiben Sie Ihre Frage  kurz! (max. 200 Charakter)"} maxLength="200" rows="8" onChange={(e) => CaseSet(e.target.value)} />
                            </div>
                            <div id="btn-pos">
                                <button id="button" type="submit" >{sendTitle}</button>
                            </div>
                        </form>
                    </td>
