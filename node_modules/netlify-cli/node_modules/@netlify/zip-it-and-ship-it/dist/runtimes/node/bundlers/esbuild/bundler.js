...
const bundleJsFile = function ({ additionalModulePaths, basePath, config, externalModules = [], ignoredModules = [], name, srcDir, srcFile, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const targetDirectory = yield (0, tmp_promise_1.tmpName)();
        ...
        try {
            const { metafile = { inputs: {}, outputs: {} }, warnings } = yield (0, esbuild_1.build)({
                bundle: true,
                entryPoints: [srcFile],
                external,
                logLevel: 'warning',
            ...
            error.customErrorInfo = {
                ...
                location: { bundler: consts_1.JS_BUNDLER_ESBUILD, functionName: name, runtime: consts_1.RUNTIME_JS },
            };
            throw error;
        }
    });
...
const getCleanupFunction = (paths) => () => __awaiter(void 0, void 0, void 0, function* () {
    yield Promise.all(paths.filter(Boolean).map(fs_1.safeUnlink));
});
